        ...
        message = [
            {
                ...
                Match this job description with applied resume: {resume}. Analyaze the ability of each candidate (don't use pronunciation for gender) as follows - You must find the name, email, 
                ...
                And also you must review, note for consideration and summary of the resume (each topic no more than 60 words for each line).The 
